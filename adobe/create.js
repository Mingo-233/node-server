...
(async () => {
  let readStream;
  const PDF_SERVICES_CLIENT_ID = "ed8ab64453ba4cdab86ab56d96b95cb9";
  const PDF_SERVICES_CLIENT_SECRET = "p8e-BXm92QkgBixhR4AKCKvSUFBQKm8mbTJy";
  try {
    ...
    readStream = fs.createReadStream("../songzi.tif");
    const inputAsset = await pdfServices.upload({
      readStream,
      mimeType: MimeType.TIF,
    });
